...
<div id="top">
  <!-- 1. 로고영역 -->
  <div class="logo">
    <i class="fa-sharp fa-regular fa-futbol" id="icon"></i>
    <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/php_source/project/index.php" id="title">Football Community</a>
  </div>
...
<div id="menu_bar">
  <ul id="menu_bar_ul">
    ...
    <li><a href="http://<?= $_SERVER['HTTP_HOST'] . '/php_source/project/image_board/image_board_list.php' ?>">이미지게시판</a></li>
  </ul>
</div>