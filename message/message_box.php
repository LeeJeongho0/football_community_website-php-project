...
<body>
  <header>
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/php_source/project/common/message_page_lib.php";
    ?>
  ...
  <section>
    <div id="message_box">
      ...
      <div>
        ...
        <ul class="buttons">
          <li><button class="btn btn-secondary" onclick="location.href='message_box.php?mode=rv'">수신 쪽지함</button></li>
          <li><button class="btn btn-secondary" onclick="location.href='message_box.php?mode=send'">송신 쪽지함</button></li>
          <li><button class="btn btn-secondary" onclick="location.href='message_form.php'">쪽지 보내기</button></li>
        </ul>
      </div> <!-- message_box -->
  </section>
  <footer>
